...
public class EntityServiceTests
{
    ...
    public void CreateEntity_Should_Call_Insert_And_Pass_Correct_Data()
    {
        ...
        mockRepo.Setup(r => r.InsertEntity(It.IsAny<Entity>())).Returns(1);
    ...
    public void UpdateEntity_Should_Call_Update_And_Pass_Correct_Data()
    {
        ...
        mockRepo
            .Setup(r => r.GetEntityByName("aragorn", EntityType.pc))
            .Returns(
                new EntityRecord
                {
                    Id = 1,
    ...
    public void DeleteEntity_Should_Not_Call_Repo_When_Name_Is_Empty()
    {
        ...
        Assert.Throws<ArgumentException>(() => service.DeleteEntity("", EntityType.pc));
